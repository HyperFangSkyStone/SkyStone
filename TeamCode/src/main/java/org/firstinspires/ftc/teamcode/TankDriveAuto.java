    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(isStarted())
        {
            if (skystonePosition == 1)
            {
                ...
                turnethDirection(4,0.6, 0.4, 0.005, 3);
                ...
                sleep(250);
                runIntake(0);
                movethForward(-25, 2.5, 0.001, 0.6);
                runIntake(0.5);
                sleep(310);
                runIntake(0);
                freeze();
                turnethDirection(-94,0.4, 0.2, 0.005, 3);
            }
            else if (skystonePosition == 2)
            {
                ...
                runIntake(0);
                freeze();
                turnethDirection(-90,0.4, 0.2, 0.005, 3);
            }
            else if (skystonePosition == 3)
            {
                movethForward(2, 2.5, 0.001, 0.6);
                turnethDirection(-8,0.6, 0.4, 0.005, 3);
                movethForward(24, 2.5, 0.001, 0.6);
                freeze();
                runIntake(-0.75);
                movethForward(15, 2.5, 0.001, 0.6);
                ...
                runIntake(0);
                freeze();
                turnethDirection(-82,0.4, 0.2, 0.005, 3);
            }
            else
            {
                telemetry.addData("ERROR", "SkyStone Not Found.");
