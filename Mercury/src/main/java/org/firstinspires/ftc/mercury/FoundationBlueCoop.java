...
@Autonomous(name="Foundation Blue Coop", group="blue")
@Disabled
public class FoundationBlueCoop extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(isStarted())
        {
            ...
            turnOneWheelDirection(-90, 1.0, 1, 0.0111, 8, 'r'); // Movement 2
            pidLinearMovement(10, 3);
            tankDrive.fang(true);
            freeze();
